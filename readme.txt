...
Donate link: http://cagewebdev.com/donations-opm/
Plugin Name: Order Your Posts Manually
Plugin URI: http://cagewebdev.com/order-posts-manually/
Tags: database, post, posts, order, ordering, sort, sorting, manually, scroll, drag and drop, drag, drop, infinite scroll, creation date, modification date
